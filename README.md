...
| Guide | PDF |
|---|---|
| Neuron Developer's Guide | [`Neuron-Developers-Guide.pdf`](docs/pdf/Neuron-Developers-Guide.pdf) |
| DAG Authoring Guide | [`DAG-Authoring-Guide.pdf`](docs/pdf/DAG-Authoring-Guide.pdf) |
| Neuron Architecture | [`Neuron-Architecture.pdf`](docs/pdf/Neuron-Architecture.pdf) |
...
<sub>Source: `holok-ai/bigbrain` @ `6ef0de4`</sub>
